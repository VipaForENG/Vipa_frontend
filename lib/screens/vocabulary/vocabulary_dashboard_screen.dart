...
class _VocabularyDashboardScreenState extends State<VocabularyDashboardScreen> {
  ...
  Widget _buildDashboardBody(
    VocabularyDashboardProvider provider,
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      Navigator.pushNamed(
                        context,
                        AppRoutes
                            .vocabulary, // 🌟 이 경로는 app_routes.dart에 맞춰주세요! (vocabulary 또는 grammar)
                        arguments: {
          ...
          Row(
            children: [
              IconButton(
                ...
                onPressed: () => provider.adjustCount(type, -1),
              ),
              SizedBox(
                width: 60,
                child: Text(
