...
import '../../design/card_design.dart'; // 👈 디자인 파일 임포트
  ...
  Widget _buildListItem(String text) {
    return InkWell(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            Icon(Icons.check_circle_rounded, size: 18, color: Colors.grey.shade300),
            const SizedBox(width: 12),
            Expanded(
              child: Text(text,
                  style: const TextStyle(fontSize: 15, color: Colors.black87, letterSpacing: -0.5)),
            ),
