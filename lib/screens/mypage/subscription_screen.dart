...
class _SubscriptionScreenState extends State<SubscriptionScreen> {
  ...
  // [로직] 구버전 Map 대신, 리더님의 최신 SubscriptionPlan 모델 리스트 유지
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: AppColors.background, // [UI] 디자인 시스템 톤 적용
      appBar: AppBar(
        title: const Text(
          "멤버십 구독",
  ...
  // [로직] Model 기반 접근 방식으로 수정 완료 (plan['name'] -> plan.name)
