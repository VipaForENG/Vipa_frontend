...
class CategorySelectionScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<MainCategory>>(
        future: ConversationController.fetchMainCategories(), // API 호출 (백엔드와 통신)
  ...
  Widget _buildCategoryCard(BuildContext context, MainCategory category) {
    return InkWell(
      onTap: () {
        debugPrint('[UI Event] Category Selected: ${category.title} (ID: ${category.mainCatId})');
      ...
      child: Card(
        ...
        child: Column(
          ...
          children: [
            const Icon(Icons.flight_takeoff, size: 50, color: Color(0xFF8877FF)),
